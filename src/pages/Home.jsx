...
function Home() {
  return (
    <>
      {/* Header */}
      <div className="w-[90vw] mx-auto flex flex-col md:flex-row justify-between items-center py-5 gap-4 md:gap-0">
        {/* Netflix Icon */}
        <Link to="/">
          <svg
            viewBox="0 0 111 30"
        ...
        {/* Navigation Links */}
        <div className="text-white font-light flex flex-wrap justify-center gap-2 md:gap-3">
          <Link to="/hollywood" className="border border-neutral-100 py-2 px-4 rounded-md text-sm md:text-base">
            Hollywood
          </Link>
          <Link to="/bollywood" className="border border-neutral-100 py-2 px-4 rounded-md text-sm md:text-base">
            Bollywood
          </Link>
          <Link to="/most-popular" className="border border-neutral-100 py-2 px-4 rounded-md text-sm md:text-base">
            Most-Popular
          </Link>
          <Link to="/wishlist" className="border border-neutral-100 py-2 px-4 rounded-md text-sm md:text-base">
            Wishlist
          </Link>
          <Link to="/login" className="border border-neutral-100 py-2 px-4 rounded-md text-sm md:text-base">
            Login
          </Link>
        </div>
      </div>
      ...
      <div className="w-[90vw] mx-auto flex gap-4 mt-10 justify-center flex-wrap">
        {movies.map((movie) => (
          <MovieCard key={movie.slug} slug={movie.slug} img={movie.img} />
        ))}
      </div>
    </>
  );
