...
function Bollywood() {
  const suggestions = movies.filter((data) => data.type === "Bollywood");

  return (
    <>
      {/* Header: Netflix Logo + Home Button */}
      <div className="flex justify-between items-center mt-auto px-4 sm:px-6 lg:px-10 py-4">
        {/* Netflix Logo */}
      ...
      {/* Movie Grid */}
      <div className="mt-16 px-4 sm:px-6 lg:px-10 w-full max-w-screen-xl mx-auto">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 sm:gap-6 md:gap-8">
          {suggestions.map((movie, idx) => (
            <MovieCard key={idx} img={movie.img} slug={movie.slug} />
          ))}
        </div>
      </div>
    </>
