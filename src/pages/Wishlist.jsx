            ...
            {wishlist.map((movie, idx) => (
              <div key={idx} className="relative group">
                ...
                <button
                  ...
                  className="absolute bottom-2 left-2 bg-red-600 bg-opacity-90 opacity-80 text-white text-xs px-3 py-1 rounded hover:bg-red-700 hover:opacity-100 transition shadow-md"
                >
                  Remove
                </button>
              </div>
